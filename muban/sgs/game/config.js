window.config={
	...
	all:{
		...
		stockextension:['boss','cardpile','coin','wuxing','新神周瑜'],
	...
	connect_avatar:'daqiao',
	connect_nickname:'mathskiller',
	config_menu:true,
	...
	characters:['standard','shenhua','refresh','sp','yijiang','extensionszy'],
	connect_characters:[],
	connect_cards:[],
	plays:[],
	extensions:[],
